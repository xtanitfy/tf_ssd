...
VOC2007TEST
    ...
    ImageSets
'''
dataset_path = 'data/VKITTI/VOC2007TEST'
# change above path according to your system settings
pred_path = './logs/SSD/eval_val'
pred_file = 'results_{}.txt' # from 1-num_classes
output_path = './logs/SSD/eval_val/eval_output'
cache_path = './logs/SSD/eval_val/eval_cache'
...
def do_python_eval(use_07=True):
    ...
    for cls_name, cls_pair in VOC_LABELS.items():
        if 'none' in cls_name:
            continue
        cls_id = cls_pair[0]
